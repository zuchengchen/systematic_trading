...
\noindent The following chapters in part three will describe each component in more detail. In the final part of the book I'll show three examples of how this framework can be used, for semi-automatic traders, asset allocating investors and staunch systems traders.
...
\noindent{\small \setlength{\tabcolsep}{3pt} \renewcommand{\arraystretch}{1.15} \begin{breakabletabularx}{\textwidth}{@{} p{0.19\textwidth} p{0.24\textwidth} Y@{}}
\toprule
