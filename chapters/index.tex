\chapter*{Index} \phantomsection \addcontentsline{toc}{chapter}{Index} \markboth{Index}{Index}
...
\par \noindent\hangindent=1.20em\hangafter=1\hspace*{0.00em} Zuckerman, Gregory, 31f \end{multicols}
...
\vspace{1.5em} Our readers mean everything to us at Harriman House. As a special \par thank you for buying this book, let us help you save as much as \par possible on your next read: \par \vspace{1.5em} If you've never ordered from us before, get \pounds5 off your first order at \par harriman-house.com with this code: \texttt{st51} \par \vspace{1em} Already a customer? Get \pounds5 off an order of \pounds25 or more with this \par code: \texttt{st25} \par \vspace{1em} Get 7 days' FREE access to hundreds of our books at volow.co --- \par simply head to the website and sign up. \par \vspace{1.5em} Thanks again! \par from the team at Harriman House \par \vfill
