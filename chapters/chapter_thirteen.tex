...
\begin{tabularx}{\textwidth}{@{} p{0.30\textwidth} Y@{}}\textbf{Who are you?} & Introducing the semi-automatic trader. \\
...
\rawtablecaption{TRANSLATING OPINIONS INTO A QUANTIFIED FORECAST141} \begingroup \small \setlength{\tabcolsep}{2pt} \renewcommand{\arraystretch}{1.15} \begin{tabularx}{\textwidth}{@{}*{9}{>{\centering\arraybackslash} X}@{}}
\toprule
