...
\rawtablecaption{IN THIS SIMPLE EXAMPLE HANDCRAFTED WEIGHTS FOR TRADING SUBSYSTEMS ARE THE SAME AS FOR THE ASSETS THEMSELVES}
\begingroup
\small
\centering
\begin{tabular}{@{}lr@{}}
...
\rawtablecaption{CORRELATION MATRIX OF TRADING SUBSYSTEMS FOR THREE EXAMPLE ASSETS}
\begingroup
\small
\centering
\begin{tabular}{@{}lccc@{}}
...
\rawtablecaption{CALCULATING THE INSTRUMENT VALUE VOLATILITY FOR THE THREE ASSETS IN THE EXAMPLE PORTFOLIO}
\begingroup
\small
\centering
\resizebox{\textwidth}{!}{%
...
\rawtablecaption{CALCULATING THE SUBSYSTEM POSITION FOR THE THREE TRADING SUBSYSTEMS IN THE EXAMPLE PORTFOLIO}
\begingroup
\small
\centering
\resizebox{\textwidth}{!}{%
...
\rawtablecaption{CALCULATING THE PORTFOLIO INSTRUMENT POSITION FOR THE EXAMPLE PORTFOLIO}
\begingroup
\small
\centering
\resizebox{\textwidth}{!}{%
...
\rawtablecaption{CALCULATING THE REQUIRED TRADE GIVEN THE ROUNDED TARGET POSITIONS AND SOME ARBITRARY CURRENT POSITIONS}
\begingroup
\small
\centering
\resizebox{\textwidth}{!}{%
