...
In my \textbf{framework} you will be optimising the weights of \textbf{trading subsystems}, each taking positions in one \textbf{instrument}, rather than looking at portfolios of positions in instruments. Because \textbf{asset allocating investors} have \textbf{static} portfolios they can use the correlation of the underlying instrument returns from tables 50 to 55 without any adjustment. For \textbf{staunch systems traders} with \textbf{dynamic} forecasts a good rule of thumb is that the correlation between instrument subsystem returns will be around 0.70 multiplied by the correlation of instrument price returns.
