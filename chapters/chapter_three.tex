...
fitting.} selecting a set of trading rules that fit past data too well and which are unlikely
...
9.\footnote{This is sometimes called anchored fitting.} Suppose you think you need at least
...
window.\footnote{Another widely used term for this is walk forward fitting.} As figure 10
...
$1.5 \times B$, $2 \times B$, ... $5 \times B$. This gives 90 possible variations in all.} This
...
the answer is not influenced by how each series of random numbers come out.}
...
non-disclosure agreement.} Fitting separately is common, and many system traders take
...
cover in chapter twelve, ``Speed and Size''.}
...
technique then you need to keep your degrees of freedom appropriately small.}
