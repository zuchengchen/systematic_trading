...
\chapteroverviewitem{What makes a good trading rule}{Some key elements that make a trading rule more likely to be successful.}
\chapteroverviewitem{When trading rules don't work}{Reasons why a trading rule which worked in back-test may not work in practice when actually traded.}
\chapteroverviewitem{Why are certain rules profitable?}{Explanations for why profit making rules exist, to help you work out if that profitability is likely to be repeatable.}
\chapteroverviewitem{Classifying trading styles}{The main ways in which you can classify rules into trading styles, and the important characteristics each style has.}
\chapteroverviewitem{Achievable Sharpe ratios}{What are realistic Sharpe ratios to expect?}
...
\footnotetext[\thefootnote]{An exhaustive treatment of this topic can be found in \textit{Expected Returns} by Antti Ilmanen.}
...
\begin{figure}[htbp] \centering \includegraphics[width=\textwidth]{figures/raw/img-005.png} \caption{Two assets, same Sharpe ratio, different skews.} \end{figure}
